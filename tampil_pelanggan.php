    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="theme-assets/images/backgrounds/02.jpg">
        ...
        <div class="main-menu-content">
          <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" active "><a href="tampil_pelanggan.php"><i class="la la-user"></i><span class="menu-title" data-i18n="">Pelanggan</span></a>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Pelanggan</h3>
          </div>
          <div class="content-header-right col-md-8 col-12">
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="index.php">Pelanggan</a>
                  </li>
      ...
      <div class="col-12">
          <div class="card">
            ...
            ?>
                ...
                <td><a href="tambah_pelanggan.php?id_siswa=?>" class="btn btn-primary">Tambah Pelanggan</a></td>
