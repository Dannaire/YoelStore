                        ...
                        <div class="header-search header-search-extended header-search-visible d-none d-lg-block">
                            ...
                            <form action="#" method="get">
                                <div class="header-search-wrapper search-wrapper-wide">
                                    ...
                                    <button class="btn btn-succes" type="submit"><i class="icon-search"></i></button>
...
$qry_buku=mysqli_query($conn,"select * from produk where id_produk between 25 and 35 order by id_produk desc ");
...
<div class="product-body">
        ...
        <footer class="footer">
	        ...
	        <div class="footer-bottom">
	        	<div class="container">
	        		<p class="footer-copyright">Copyright © 2022 Yoel Store. All Rights Reserved.</p><!-- End .footer-copyright -->
