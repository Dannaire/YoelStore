        ...
        <div class="navbar-header">
          <ul class="nav navbar-nav flex-row">       
            <li class="nav-item mr-auto"><a class="navbar-brand" href="index.php"><img class="brand-logo" alt="Chameleon admin logo" src="theme-assets/images/logo/logo1.png"/>
                <h3 class="brand-text">Yoel Store</h3></a></li>
            <li class="nav-item d-md-none"><a class="nav-link close-navbar"><i class="ft-x"></i></a></li>
          </ul>
        </div>
        <div class="main-menu-content">
          <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="active"><a href="index.php"><i class="ft-home"></i><span class="menu-title" data-i18n="">Home</span></a>
            </li>
            ...
            <li class=" nav-item"><a href="histori_petugas.php"><i class="la la-calendar-check-o"></i><span class="menu-title" data-i18n="">Transaksi</span></a>
            </li>
...
<div class="row">
    <div class="col-xl-4 col-lg-6 col-md-12">
        <div class="card pull-up ecom-card-1 bg-white">
            <div class="card-content ecom-card2 height-180">
                <h5 class="text-muted danger position-absolute p-1">Pendapatan Bulan ini</h5>
                <?php
                                               include "toko_online.php";
                                                $qry_get_buku=mysqli_query($conn,"select sum(d.subtotal) as SubTotal    , year(t.tgl_transaksi), month(t.tgl_transaksi) from transaksi t join detail_transaksi d on d.id_transaksi=t.id_transaksi GROUP BY year(t.tgl_transaksi), month(t.tgl_transaksi) " );
           ...
           <center>
            ...
            <br>
            <br>
            <h1>   <?php echo $b['SubTotal']?></h1> </center> 
            </div>
        </div>
    </div>
    <div class="col-xl-4 col-lg-6 col-md-12">
        <div class="card pull-up ecom-card-1 bg-white">
            <div class="card-content ecom-card2 height-180">
                <h5 class="text-muted info position-absolute p-1">Total pendapatan</h5>
                <div>
    ...
    <div class="col-xl-4 col-lg-12">
        <div class="card pull-up ecom-card-1 bg-white">
            <div class="card-content ecom-card2 height-180">
                <h5 class="text-muted warning position-absolute p-1">Pendapatan Hari Ini</h5>
                <?php
                include "toko_online.php";
                                                $qry_get_buku=mysqli_query($conn,"select sum(d.subtotal) as SubTotal    , year(t.tgl_transaksi), month(t.tgl_transaksi),day(t.tgl_transaksi) from transaksi t join detail_transaksi d on d.id_transaksi=t.id_transaksi GROUP BY year(t.tgl_transaksi), month(t.tgl_transaksi) ,day(t.tgl_transaksi)" );
                                                $b=mysqli_fetch_assoc($qry_get_buku);   
                                                ?>
                                                 <center>
            <br>
    ...
    <div class="col-xl-4 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="heading-multiple-thumbnails">Yoel Store</h4>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <h4 class="card-title">Yoel Store</h4>
                        <p class="card-text"> Situs jual beli online terlengkap dengan berbagai pilihan toko online terpercaya. Belanja online mudah dan menyenangkan di Yoel Store. Pengiriman cepat. </p>
                        <p class="card-text">
                            Yoel Store adalah pasar online terbesar di Indonesia, memungkinkan individu dan bisnis untuk membuka dan mengelola toko online mereka sendiri dengan mudah. Yoel Store telah menerima dana lebih dari $100 juta dari Softbank Jepang dan perusahaan modal ventura teknologi Amerika yang terkenal, Sequoia Capital.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle text-muted">Product Yoel Store</h6>
                </div>
                <div id="carousel-area" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img src="gambar/82c33d0b-e834-487e-8232-bf04cb7c4ec2.jpg" class="d-block w-100" alt="First slide">
                        </div>
                    
                        <div class="carousel-item">
                            <img src="gambar/c8fa638350c6b1d1716ff669a093d910.jpg" class="d-block w-100" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img src="gambar/download (12).jpg" class="d-block w-100" alt="Third slide">
                        </div>
                    </div>
                ...
                <div id="recent-buyers" class="media-list">
                    <a href="#" class="media border-0">
                        ...
                        <div class="media-body w-100">
                            <span class="list-group-item-heading">Zidane
                    ...
                    <a href="#" class="media border-0">
                        ...
                        <div class="media-body w-100">
                            <span class="list-group-item-heading">Naufal
                    ...
                    <a href="#" class="media border-0">
                        ...
                        <div class="media-body w-100">
                            <span class="list-group-item-heading">Ahmad Alex
                    ...
                    <a href="#" class="media border-0">
                        ...
                        <div class="media-body w-100">
                            <span class="list-group-item-heading">Reyhan
                    ...
                    <a href="#" class="media border-0">
                        ...
                        <div class="media-body w-100">
                            <span class="list-group-item-heading">Agung Farrel
