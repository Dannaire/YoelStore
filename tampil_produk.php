    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="theme-assets/images/backgrounds/02.jpg">
        ...
        <div class="main-menu-content">
          <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" active"><a href="tampil_produk.php"><i class="la la-gift"></i><span class="menu-title" data-i18n="">Produk</span></a>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Petugas</h3>
          </div>
      ...
      <div class="col-12">
        ...
        <?php
                    ...
                    ?>
                        ...
                        <td><img width="120" height="120" src="gambar/<?=$data_produk['foto']?>"></td>
            ...
            <td><a href="icons.html" class="btn btn-primary">Tambah Produk</a></td>
        </div>
